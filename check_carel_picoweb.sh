...
# simple check for carel pcoweb  cooling systems
...
# SNMP integer workaround
in_warning=`echo $warn*10|bc`
in_critical=`echo $crit*10|bc`


# nagios exit codes & statuses function
function statecomp {
